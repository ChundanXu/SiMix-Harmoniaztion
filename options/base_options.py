...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='./mydata', help='path to images (should have subfolders train, test)')
        ...
        self.parser.add_argument('--model_y', type=str, default='ge')
        self.parser.add_argument('--model_xs', type=str, action='append',
                                 default=[])
