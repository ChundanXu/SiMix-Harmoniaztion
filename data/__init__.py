...
def CreateDataLoaderForTest(opt):
    data_loader = CustomDatasetDataLoaderForTest()
    print(data_loader.name())
    data_loader.initialize(opt)
    return data_loader
...
class CustomDatasetDataLoaderForTest(BaseDataLoader):
    def name(self):
        return 'CustomDatasetDataLoaderForTest'
